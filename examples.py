...
examples = [
    ...
    },
    {
        ...
        "response": "Still figuring things out? You're not alone. New cities, new skills, new questions—it's all part of the ride. That's where Connect & Learn steps in. This summer, SAIC is bringing students and alumni together in the Pink City—where centuries of history echo through bold, new voices and stories flow as easily as sand. It's where experiences are unpacked, ideas are challenged, and every interaction has the potential to shape what comes next. If you are seeking connection, clarity, a sense of direction or just the comfort of being understood, this is the place for you. Event Details: Date: 11 July, Friday Time: 6:00 PM Onwards Venue: Seats are limited. Register now through the link in our bio."
    },
    {
...
def get_example_selector():
    ...
    google_embeddings = GoogleGenerativeAIEmbeddings(
        model="models/gemini-embedding-001", # Best model for semantic search
        task_type="retrieval_query" # Optimization for retrieval tasks
    )
